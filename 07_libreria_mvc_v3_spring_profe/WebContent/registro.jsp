...
<script type="text/javascript">
	...
	function validarUsuario(){
		if(document.getElementById("usuario").value.trim()!=""){
			...
			alert("El campo usuario debe tener un valor");
			return false;
		}
	}
	function validarPwd(){
...
<div class="container">
	...
	<form action="doRegistrar" method="post" onsubmit="return validar()">
		...
		<div class="form-group">
			<label>Contraseña:</label><input type="password" name="password" id="password" class="form-control" style="width:30%" placeholder="password" />
		</div>
		<div class="form-group">
			<label>Repetir Contraseña:</label><input type="password" name="repetirpwd" id="repetirpwd" class="form-control" style="width:30%" placeholder="password" />
		</div>
		<div class="form-group">
			<label>Email:</label><input type="text" name="email" id="email" class="form-control" style="width:30%" placeholder="Email"/>
		</div>
		<div class="form-group">
			<label>Teléfono:</label><input type="number" name="telefono" id="telefono" class="form-control" style="width:30%" placeholder="telefono"/>
		</div>
